...
export function getSession() {
  ...
  // Use memory store for development, MongoDB for production
  let sessionStore;
  if (isDevelopment) {
...
export const isAuthenticated: RequestHandler = async (req, res, next) => {
  // Skip authentication in development mode or production without Replit Auth
  if (isDevelopment || process.env.NODE_ENV === 'production') {
    console.log("⚠️  Skipping authentication check in development/production mode");
    return next();
  }
